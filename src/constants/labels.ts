export const LABELS = {
  ...
  // Settings Labels
  SETTINGS_LOAD_FAIL: "Settings could not be fetched",
  SETTINGS_UPDATE_FAIL: "Settings could not be updated",
  SETTINGS_AND_PRIVACY: "Settings & Privacy",
  SETTINGS_DESCRIPTION: "Change SETTINGS",
  ...
  SETTINGS_THEME_DESCRIPTION: "Change your theme",
  SETTINGS_LOCATION: "Location",
  SETTINGS_LOCATION_DESCRIPTION: "Select who can see your location",
  SETTINGS_DOB: "DOB",
  SETTINGS_DOB_DESCRIPTION: "Select who can see your date of birth",
  SETTINGS_GENDER: "Gender",
  SETTINGS_GENDER_DESCRIPTION: "Select who can see your gender",
  SETTINGS_PROFILE_PHOTO: "Profile Photo",
  SETTINGS_PROFILE_PHOTO_DESCRIPTION: "Select who can see your profile photo",
  SETTINGS_EMAIL: "Email",
  SETTINGS_EMAIL_DESCRIPTION: "Select who can see your Email",
