export const LABELS = {
  ...
  SETTINGS_HEADER: "Settings & Privacy",
  SETTINGS_DISPLAY: "Display Settings",
  SETTINGS_PRIVACY: "Privacy Settings",
  SETTINGS_VISIBILITY: "Visibility Settings",
  SETTINGS_COMMUNICATIONS: "Communications",
  SETTINGS_FEED_PREFERENCES: "Feed Preferences",
  SETTINGS_THEME: "Theme",
  SETTINGS_THEME_DESCRIPTION: "Change your theme to",
  SETTINGS_LOCATION: "Location",
  SETTINGS_LOCATION_DESCRIPTION: "Select who can see you location",
  SETTINGS_DOB: "DOB",
  SETTINGS_DOB_DESCRIPTION: "Select who can see you date of birth",
  SETTINGS_GENDER: "Gender",
  SETTINGS_GENDER_DESCRIPTION: "Select who can see you gender",
  SETTINGS_PROFILE_PHOTO: "Profile Photo",
  SETTINGS_PROFILE_PHOTO_DESCRIPTION: "Select who can see you profile photo",
  SETTINGS_EMAIL:"Email",
  SETTINGS_EMAIL_DESCRIPTION: "Select who can see you Email",
  SETTINGS_PHONE_NO:"Phone Number",
  SETTINGS_PHONE_NO_DESCRIPTION: "Select who can see you phone number",
  SETTINGS_ACTIVE_STATUS: "Active status",
  SETTINGS_ACTIVE_STATUS_DESCRIPTION: "Select who can see you phone number",
  SETTINGS_BLOCKING_INFO: "Blocking Info",
  SETTINGS_BLOCKING_INFO_DESCRIPTION: "Manage blocked users",
